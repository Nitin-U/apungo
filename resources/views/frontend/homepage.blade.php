            ...
            <div class="container margin_60">
                <div class="row small-gutters categories_grid">
                    <div class="col-sm-12 col-md-6">
                        <a href="#">
                            <img src="{{ asset('assets/frontend/img/img_cat_home_1.jpg') }}" alt="" class="img-fluid">
                            <div class="wrapper">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="row small-gutters mt-md-0 mt-sm-2">
                            <div class="col-sm-6">
                                <a href="#">
                                    <img src="{{ asset('assets/frontend/img/img_cat_home_2.jpg') }}" alt="" class="img-fluid">
                                    <div class="wrapper">
                                        <h2>Tours</h2>
                                        <p>800 Locations</p>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <a href="#">
                                    <img src="{{ asset('assets/frontend/img/img_cat_home_3.jpg') }}" alt="" class="img-fluid">
                                    <div class="wrapper">
                                        <h2>Hotels</h2>
                                        <p>650 Locations</p>
                                    </div>
                            ...
                            <div class="col-sm-12 mt-sm-2">
                                <a href="#">
                                    <img src="{{ asset('assets/frontend/img/img_cat_home_4.jpg') }}" alt="" class="img-fluid">
                                    <div class="wrapper">
                                        <h2>Restaurants</h2>
                                        <p>1132 Locations</p>
                                    </div>
            ...
            <div class="owl-carousel owl-theme list_carousel add_bottom_30">
                <div class="item">
                    <div class="tour_container">
                        ...
                        <div class="img_container">
                            <a href="#">
                                <img src="{{ asset('assets/frontend/img/tour_box_1.jpg') }}" width="800" height="533" class="img-fluid" alt="image">
                ...
                <div class="item">
                    <div class="tour_container">
                        ...
                        <div class="img_container">
                            <a href="#">
                                <img src="{{ asset('assets/frontend/img/tour_box_2.jpg') }}" width="800" height="533" class="img-fluid" alt="image">
                                <div class="short_info">
                ...
                <div class="item">
                    <div class="tour_container">
                        ...
                        <div class="img_container">
                            <a href="#">
                                <img src="{{ asset('assets/frontend/img/tour_box_3.jpg') }}" width="800" height="533" class="img-fluid" alt="image">
                ...
                <div class="item">
                    <div class="tour_container">
                        ...
                        <div class="img_container">
                            <a href="#">
                                <img src="{{ asset('assets/frontend/img/tour_box_4.jpg') }}" width="800" height="533" class="img-fluid" alt="image">
                ...
                <div class="item">
                    <div class="tour_container">
                        ...
                        <div class="img_container">
                            <a href="#">
                                <img src="{{ asset('assets/frontend/img/tour_box_14.jpg') }}" width="800" height="533" class="img-fluid" alt="image">
                                <div class="short_info">
            ...
            <div class="owl-carousel owl-theme list_carousel add_bottom_30">
                <div class="item">
                    <div class="hotel_container">
                        ...
                        <div class="img_container">
                            <a href="#">
                                <img src="{{ asset('assets/frontend/img/hotel_1.jpg') }}" width="800" height="533" class="img-fluid" alt="image">
                ...
                <div class="item">
                    <div class="hotel_container">
                        ...
                        <div class="img_container">
                            <a href="#">
                                <img src="{{ asset('assets/frontend/img/hotel_2.jpg') }}" width="800" height="533" class="img-fluid" alt="image">
                ...
                <div class="item">
                    <div class="hotel_container">
                        ...
                        <div class="img_container">
                            <a href="#">
                                <img src="{{ asset('assets/frontend/img/hotel_3.jpg') }}" width="800" height="533" class="img-fluid" alt="image">
                ...
                <div class="item">
                    <div class="hotel_container">
                        ...
                        <div class="img_container">
                            <a href="#">
                                <img src="{{ asset('assets/frontend/img/hotel_4.jpg') }}" width="800" height="533" class="img-fluid" alt="image">
                                <div class="score"><span>7.5</span>Good</div>
                                <div class="short_info hotel">
                                    <span class="price"><sup>$</sup>45</span>
                                </div>
                ...
                <div class="item">
                    <div class="hotel_container">
                        ...
                        <div class="img_container">
                            <a href="#">
                                <img src="{{ asset('assets/frontend/img/hotel_5.jpg') }}" width="800" height="533" class="img-fluid" alt="image">
            ...
            <div class="container margin_60">
                ...
                <div class="row feature_home_2">
                    <div class="col-md-4 text-center">
                        <img src="{{ asset('assets/frontend/img/adventure_icon_1.svg') }}" alt="" width="75" height="75">
                    ...
                    <div class="col-md-4 text-center">
                        <img src="{{ asset('assets/frontend/img/adventure_icon_2.svg') }}" alt="" width="75" height="75">
                    ...
                    <div class="col-md-4 text-center">
                        <img src="{{ asset('assets/frontend/img/adventure_icon_3.svg') }}" alt="" width="75" height="75">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <a class="box_news" href="#">
                        <figure><img src="{{ asset('assets/frontend/img/news_home_1.jpg') }}" alt="">
                ...
                <div class="col-lg-6">
                    <a class="box_news" href="#">
                        <figure><img src="{{ asset('assets/frontend/img/news_home_2.jpg') }}" alt="">
                            <figcaption><strong>28</strong>Dec</figcaption>
                        </figure>
                        <ul>
                            <li>Jhon Doe</li>
                ...
                <div class="col-lg-6">
                    <a class="box_news" href="#">
                        <figure><img src="{{ asset('assets/frontend/img/news_home_3.jpg') }}" alt="">
                            <figcaption><strong>28</strong>Dec</figcaption>
                        </figure>
                        <ul>
                            <li>Luca Robinson</li>
                ...
                <div class="col-lg-6">
                    <a class="box_news" href="#">
                        <figure><img src="{{ asset('assets/frontend/img/news_home_4.jpg') }}" alt="">
                            <figcaption><strong>28</strong>Dec</figcaption>
                        </figure>
                        <ul>
